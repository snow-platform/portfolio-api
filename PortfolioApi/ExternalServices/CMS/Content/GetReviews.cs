...
public class GetReviews : ICmsContent
{
    ...
    {
        get =>
            $"/api/reviews?populate=category&populate=tags&pagination[page]={_pagination.SanitizePage()}&pagination[pageSize]={_pagination.SanitizeSize()}&sort[0]=publishedAt:desc";
    }
